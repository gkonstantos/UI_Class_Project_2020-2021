...
document.querySelector('#end_area').addEventListener('focusout', () => {
    let location = document.querySelector('#end_area').value;
    if (location.isEmpty()) {
...
document.querySelector('#begin_hour').addEventListener('focusout', () => {
    console.log("##@@#");
    let hour = document.querySelector('#begin_hour').value;
    if (hour.isEmpty()) {
...
document.querySelector('#end_hour').addEventListener('focusout', () => {
    let hour = document.querySelector('#end_hour').value;
    if (hour.isEmpty()) {
