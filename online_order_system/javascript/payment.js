...
document.querySelectorAll('.Button').forEach(confirm_order_button => {
    confirm_order_button.addEventListener('click', () => {
        ...
        let card_date = document.querySelector("#card_date").value;
        let card_name = document.querySelector("#card_name").value;

        if (customer_name.isEmpty() || customer_address.isEmpty() ||
            customer_phone.isEmpty() || customer_email.isEmpty()) {
